import { poltocar as point } from "./converter.js"
import { rad, TAU } from "./helper.js"
 ...
 */
export function poly(radius = 0, sides = 3) {
 ...
 */
export function coil(radius = 0, turns = 1, phase = 1, n = 1) {
 ...
 */
export function rose(radius = 0, a = 2, b = 3, offset = 0) {
 ...
 */
export function foxy(radius = 0, m1 = 0, n1, n2, n3, a = 1, b = a, m2 = m1) {
